...
import VariantsImagesMediaForm, { ImageType, MediaFormType } from "./variant-images-media-form";
...
const VariantsImagesModal = ({ variant, open, onClose, product, type, notify }: Props) => {
