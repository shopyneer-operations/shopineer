...
import { Hint as HintComponent, Label as LabelComponent, Text, Tooltip, clx } from "@medusajs/ui";
...
const Control = forwardRef<React.ElementRef<typeof Slot>, React.ComponentPropsWithoutRef<typeof Slot>>(
  ({ ...props }, ref) => {
...
const Hint = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    ...
    return <HintComponent ref={ref} id={formDescriptionId} className={className} {...props} />;
  }
);
