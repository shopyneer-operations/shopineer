  ...
  return (
    <Base preview={preview}>
      <Section>
        ...
        <Text style={{ margin: "0 0 30px" }}>Thank you for your recent order! Here are your order details:</Text>

        <Text style={{ fontSize: "18px", fontWeight: "bold", margin: "0 0 10px" }}>Order Summary</Text>
        <Text style={{ margin: "0 0 5px" }}>Order ID: {order.display_id}</Text>
        <Text style={{ margin: "0 0 5px" }}>Order Date: {new Date(order.created_at).toLocaleDateString()}</Text>
        ...
        <Text style={{ fontSize: "18px", fontWeight: "bold", margin: "0 0 15px" }}>Order Items</Text>
